    ...
    <div class="relative w-full max-w-2xl max-h-full">
        <div class="relative bg-red-700 dark:bg-red-900 rounded-xl lg:rounded-3xl shadow-sm p-4 lg:p-6 flex flex-col gap-4 lg:gap-6">
            ...
            <div class="flex flex-col gap-4 lg:gap-6">
                ...
                <p v-if="organizationData?.description" class="text-base leading-relaxed text-white">
                    {{ organizationData?.description }}
                </p>
                <p v-else="organizationData?.description" class="text-base leading-relaxed text-white">
                    {{ $t("noDescription") }}
                </p>
                <div class="flex items-center gap-4 lg:gap-6 text-white text-xl lg:text-2xl">
