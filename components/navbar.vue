        ...
        <nav class="w-full flex items-center justify-between bg-red-900 dark:bg-red-900 px-4 lg:px-16 py-4 text-white">
            <ul class="w-4/5 flex gap-4 lg:gap-16 text-sm lg:text-lg items-center justify-start">
                ...
                <NuxtLink to="/standings">
                    <Icon name="material-symbols:trophy-rounded" class="cursor-pointer" size="1.5em" mode="svg"/>
                </NuxtLink>
                <NuxtLink to="/database">
                    <Icon name="mdi:racing-helmet" class="cursor-pointer" size="1.5em" mode="svg"/>
                </NuxtLink>
                <NuxtLink to="/rentals">
                    <Icon name="material-symbols:map-rounded" class="cursor-pointer" size="1.5em" mode="svg"/>
                </NuxtLink>
            </ul>
